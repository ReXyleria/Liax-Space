...
export const settingDefinitions: SettingDefinition[] = [
  ...
  { key: "smtp.fromName", label: "Sender display name", group: "SMTP", type: SettingType.TEXT, defaultValue: "" },
  { key: "smtp.encryption", label: "SMTP encryption", group: "SMTP", type: SettingType.TEXT, defaultValue: "starttls" },
...
const localizedSettingDefinitions: Record<Locale, Record<string, { label: string; group: string }>> = {
  ...
  "zh-CN": {
    ...
    "smtp.fromName": { label: "显示名称", group: "SMTP" },
    "smtp.encryption": { label: "加密方式", group: "SMTP" },
