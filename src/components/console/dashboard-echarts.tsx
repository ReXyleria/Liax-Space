  ...
  return (
    <section className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-lg font-semibold tracking-tight">{t(locale, "consoleAnalytics")}</h2>
          <p className="text-sm text-muted-foreground">{t(locale, "consoleAnalyticsDescription")}</p>
        </div>
        <div className="inline-flex w-fit rounded-lg border bg-card p-1">
          {RANGE_OPTIONS.map((range) => (
            <Link
              ...
              href={`/console?range=${range}`}
            >
              {range} {t(locale, "consoleDays")}
            </Link>
          ))}
        </div>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base">{t(locale, "consoleDailyVisits")}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base">{t(locale, "consoleCountryRanking")}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base">{t(locale, "consoleDeviceRatio")}</CardTitle>
          </CardHeader>
          <CardContent>
