...
import { ArticleSettingsDialog } from "@/components/console/article-settings-dialog";
...
function labels(locale: Locale) {
  return locale === "en"
    ? {
        ...
        deleteDescription: "This article will be removed from the public site and console list.",
        cancel: "Cancel"
      }
    : {
        publish: "发布",
    ...
    <div ref={rootRef} className="relative flex justify-end">
      ...
      {open ? (
        ...
        >
          ...
          <Link href={`/console/articles/${article.id}/edit`} className="block rounded-md px-3 py-2 hover:bg-muted">
            {text.edit}
          </Link>
          <button
            type="button"
