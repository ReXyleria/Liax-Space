...
export default async function AdminBasicSettingsPage() {
  ...
  return (
    <SettingsSectionPage
      ...
      description={
        locale === "en"
          ? "Manage the site title, subtitle, domain, logo, theme colors, and registration entry. Homepage owner information is resolved automatically from OWNER or ADMIN accounts."
          : "管理站点标题、副标题、域名、Logo、主题色和注册入口。首页站主信息会自动从 OWNER 或 ADMIN 账户中解析。"
      }
